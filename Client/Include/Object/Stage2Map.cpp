...
void CStage2Map::Begin()
{
	CGameObject::Begin();
}

void CStage2Map::Update(float fTime)
{
	CGameObject::Update(fTime);
}

void CStage2Map::Render(float fTime)
{
	CGameObject::Render(fTime);
}

void CStage2Map::MakeMapObstacle()
{
...
void CStage2Map::SetStageSize(float minx, float maxx, float miny, float maxy)
{
	StageSizeMinX = minx;
	StageSizeMaxX = maxx;
	StageSizeMinY = miny;
